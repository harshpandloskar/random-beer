...
class SingleBrewery extends Component {
  ...
  getSingleBrewery() {
    axios({
      method: "GET",
      url: `https://o5b5d.csb.app/brewery/${this.props.match.params.id}/?key=659d5c6b8f3d2447f090119e48202fdb`
    })
      .then((res) => {
        this.setState({
  ...
  getAllBeers() {
    axios({
      method: "GET",
      url: `https://o5b5d.csb.app/brewery/${this.props.match.params.id}/beers/?key=659d5c6b8f3d2447f090119e48202fdb`
    })
      .then((res) => {
        this.setState({
          beers: res.data.data
